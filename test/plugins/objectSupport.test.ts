...
describe('objectSupport plugin', () => {
  ...
  it.each([
    ...
    expect(esday(value).format().slice(11, 19)).toBe(expected)
    expect(moment(value).format().slice(11, 19)).toBe(expected)
  })

  it('create date from short format "ms"', () => {
    const value = { ms: 14 }

    expect(esday(value).millisecond()).toBe(value.ms)
    expect(moment(value).millisecond()).toBe(value.ms)
  })
  ...
  it('create date from long format "millisecond"', () => {
    ...
    expect(esday(value).millisecond()).toBe(value.millisecond)
    expect(moment(value).millisecond()).toBe(value.millisecond)
  })
  ...
  it('create date from long plural "milliseconds"', () => {
    ...
    expect(esday(value).millisecond()).toBe(value.milliseconds)
    expect(moment(value).millisecond()).toBe(value.milliseconds)
  })
